...
begin
  Application.MessageBox('Teste de Mensagem','Atençao',MB_ICONEXCLAMATION+MB_OK);
end;

procedure TForm4.Button3Click(Sender: TObject);
begin
  Application.MessageBox('Teste de Mensagem','Informaçao', MB_ICONINFORMATION+MB_OK);
end;
...
begin
  ...
  // comando CTRL + espaço depois de digitar 'Mr', seleciona um comando do 'MB_YESNO' para selecionar no IF.
...
begin
  ...
  IF Application.MessageBox('Deseja realmente sair do Sistema?','Confirmaçao', MB_ICONQUESTION+MB_YESNO) = MrYes THEN
    begin
